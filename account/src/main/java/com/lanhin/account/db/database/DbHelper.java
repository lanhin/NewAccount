package com.lanhin.account.db.database;
...
import com.lanhin.account.db.DaoMaster;
import com.lanhin.account.db.DaoSession;
...
public class DbHelper {
    private static final String DB_NAME = "lanhin.db";//数据库名称
