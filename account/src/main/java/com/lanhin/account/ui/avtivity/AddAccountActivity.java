package com.lanhin.account.ui.avtivity;
...
import com.lanhin.account.adapter.GridPagerAdapter;
import com.lanhin.account.adapter.ViewPagerClassifyAdapter;
import com.lanhin.account.bean.AccountModel;
import com.lanhin.account.bean.RecycleClassifyPagerBean;
import com.lanhin.account.bean.RemarkBean;
import com.lanhin.account.constants.ClassifyExpendRes;
import com.lanhin.account.constants.ClassifyIncomeRes;
...
import com.lanhin.account.event.SortEvent;
import com.lanhin.account.ui.dialog.AddRemarkDialog;
import com.lanhin.account.util.KeyboardUtil;
import com.lanhin.account.util.SPUtil;
...
public class AddAccountActivity extends BaseActivity {
    ...
    private int mOutInType = Extra.ACCOUNT_TYPE_EXPEND; //记账类型 支出/收入
    ...
    private void setListener() {
        mRgType.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                switch (checkedId) {
                    case R.id.rb_expend:
                        mOutInType = Extra.ACCOUNT_TYPE_EXPEND;
                        setRecycleData(Extra.ACCOUNT_TYPE_EXPEND);
                        initPagerWithGridView(INIT);
                        break;
                    case R.id.rb_income:
                        mOutInType = Extra.ACCOUNT_TYPE_INCOME;
    ...
    private void saveData(float result) {
        ...
        if (mOutInType == Extra.ACCOUNT_TYPE_EXPEND) {
        ...
        if (mOutInType == Extra.ACCOUNT_TYPE_INCOME) {
...
//        }
    ...
    public void onEvent(SortEvent messageEvent) {
        if (mOutInType == Extra.ACCOUNT_TYPE_EXPEND)
            mExpendCommonList = SPUtil.getCommonList(this, Extra.ACCOUNT_TYPE_EXPEND);
        if (mOutInType == Extra.ACCOUNT_TYPE_INCOME)
            mIncomeList = SPUtil.getCommonList(this, Extra.ACCOUNT_TYPE_INCOME);
        //末尾自定义条目添加
