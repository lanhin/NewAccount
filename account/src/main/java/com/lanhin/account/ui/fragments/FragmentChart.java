...
import com.lanhin.account.event.ChartClassifyEvent;
import com.lanhin.account.ui.dialog.ListPopWindow;
import com.lanhin.account.ui.fragments.adapter.BaseFragmentPagerAdapter;
import com.lanhin.account.ui.fragments.chart.ChartPopWindowAdapter;
import com.lanhin.account.util.AccListUtil;
import com.lanhin.account.util.DensityUtil;
import com.lanhin.account.view.SliderLayout;
...
//    TabLayout mTabPeriod;
    ...
    private ArrayList<ChartTypeFragment> mTypeFragmentList = new ArrayList<>();
    ...
    private void initChartData() {
        mTitleList.clear();
        mTypeFragmentList.clear();
        mTitleList.add("周");
        mTitleList.add("月");
        mTitleList.add("年");

        mTypeFragmentList.add(ChartTypeFragment.newInstance(ChartTypeFragment.TYPE_WEEK));
        mTypeFragmentList.add(ChartTypeFragment.newInstance(ChartTypeFragment.TYPE_MONTH));
        mTypeFragmentList.add(ChartTypeFragment.newInstance(ChartTypeFragment.TYPE_YEAR));
    }
    ...
    private void initViewPager() {
        ...
        BaseFragmentPagerAdapter adapter = new BaseFragmentPagerAdapter(getChildFragmentManager(), mTypeFragmentList, mTitleList);
...
//                //Logger.e(position + "");mTypeFragmentList.get(position).getTypeListData()
//
//            }
//
//            @Override
