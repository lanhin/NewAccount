...
import com.lanhin.account.adapter.AddSortAdapter;
...
import com.lanhin.account.constants.SPkeys;
import com.lanhin.account.event.SortEvent;
import com.lanhin.account.event.UserDefineEvent;
import com.lanhin.account.ui.drag.ItemDragHelperCallback;
import com.lanhin.account.util.CompareUtil;
...
public class AddSortActivity extends BaseToolBarActivity {
    ...
    protected void initView() {
        ...
        setTitle(mAccountType == Extra.ACCOUNT_TYPE_EXPEND ? "支出" : "收入");
        initRecyclerView();
        //注册事件
